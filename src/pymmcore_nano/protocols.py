...
@runtime_checkable
class PySignalIO(PyDevice, Protocol):
    """Protocol for Python SignalIO (DA/AD) devices."""
    ...
    def get_da_sequence_max_length(self) -> int: ...
    def load_da_sequence(self, sequence: list[float]) -> None: ...
    def start_da_sequence(self) -> None: ...
    def stop_da_sequence(self) -> None: ...
