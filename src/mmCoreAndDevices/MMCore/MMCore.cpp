 ...
 */
void CMMCore::setPixelSizedxdz(const char* resolutionID, double dxdz)  noexcept(false)
{
   CheckConfigPresetName(resolutionID);
 ...
 */
void CMMCore::setPixelSizedydz(const char* resolutionID, double dydz)  noexcept(false)
{
   CheckConfigPresetName(resolutionID);
 ...
 */
void CMMCore::setPixelSizeOptimalZUm(const char* resolutionID, double optimalZ)  noexcept(false)
{
   CheckConfigPresetName(resolutionID);
 ...
 */
double CMMCore::getPixelSizedxdz() noexcept(false)
{
 ...
 * @return        angle (dx/dz) of the Z-stage axis with the camera axis (dimensionless)
 */
double CMMCore::getPixelSizedxdz(bool cached) noexcept(false)
{
   std::string resolutionID;
   resolutionID = getCurrentPixelSizeConfig(cached);
 ...
 * @return        Angle (dx/dz) of the Z-stage axis with the camera axis (dimensionless)
 */
double CMMCore::getPixelSizedxdz(const char* resolutionID) noexcept(false)
{
   CheckConfigPresetName(resolutionID);
 ...
 */
double CMMCore::getPixelSizedydz() noexcept(false)
{
 ...
 * @return   angle (dy/dz) of the Z-stage axis with the camera axis (dimensionless)
 */
double CMMCore::getPixelSizedydz(bool cached) noexcept(false)
{
   std::string resolutionID;
   resolutionID = getCurrentPixelSizeConfig(cached);
 ...
 * @return   angle (dy/dz) of the Z-stage axis with the camera axis (dimensionless)
 */
double CMMCore::getPixelSizedydz(const char* resolutionID) noexcept(false)
{
   CheckConfigPresetName(resolutionID);
 ...
 */
double CMMCore::getPixelSizeOptimalZUm() noexcept(false)
{
 ...
 * @cached   Uses System state cache to find active pixel size config when true
 */
double CMMCore::getPixelSizeOptimalZUm(bool cached) noexcept(false)
{
   std::string resolutionID;
   resolutionID = getCurrentPixelSizeConfig(cached);
 ...
 * pixel size configuration
 */
double CMMCore::getPixelSizeOptimalZUm(const char* resolutionID) noexcept(false)
{
   CheckConfigPresetName(resolutionID);
...
*/
void CMMCore::pressurePumpStop(const char* deviceLabel) noexcept(false)
{
...
* Calibrates the pump
*/
void CMMCore::pressurePumpCalibrate(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<PressurePumpInstance> pPump =
        deviceManager_->GetDeviceOfType<PressurePumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
bool CMMCore::pressurePumpRequiresCalibration(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<PressurePumpInstance> pPump =
        deviceManager_->GetDeviceOfType<PressurePumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
double CMMCore::getPumpPressureKPa(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<PressurePumpInstance> pPump =
        deviceManager_->GetDeviceOfType<PressurePumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::setPumpPressureKPa(const char* deviceLabel, double pressurekPa) noexcept(false)
{
    std::shared_ptr<PressurePumpInstance> pPump =
        deviceManager_->GetDeviceOfType<PressurePumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::volumetricPumpStop(const char* deviceLabel) noexcept(false)
{
...
* Homes the pump
*/
void CMMCore::volumetricPumpHome(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
bool CMMCore::volumetricPumpRequiresHoming(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::invertPumpDirection(const char* deviceLabel, bool invert) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
bool CMMCore::isPumpDirectionInverted(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::setPumpVolume(const char* deviceLabel, double volUl) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
double CMMCore::getPumpVolume(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::setPumpMaxVolume(const char* deviceLabel, double volUl) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
double CMMCore::getPumpMaxVolume(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::setPumpFlowrate(const char* deviceLabel, double UlperSec) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
double CMMCore::getPumpFlowrate(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::pumpStart(const char* deviceLabel) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::pumpDispenseDurationSeconds(const char* deviceLabel, double seconds) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
...
*/
void CMMCore::pumpDispenseVolumeUl(const char* deviceLabel, double microLiter) noexcept(false)
{
    std::shared_ptr<VolumetricPumpInstance> pPump =
        deviceManager_->GetDeviceOfType<VolumetricPumpInstance>(deviceLabel);
    mm::DeviceModuleLockGuard guard(pPump);
